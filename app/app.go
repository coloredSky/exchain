...
func NewOKExChainApp(
	...
	app.SetParallelTxHandlers(updateFeeCollectorHandler(app.BankKeeper, app.SupplyKeeper), evmTxFeeHandler(app.AccountKeeper, app.EvmKeeper), fixLogForParallelTxHandler(app.EvmKeeper))
